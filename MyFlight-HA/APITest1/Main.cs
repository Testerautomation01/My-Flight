    ...
    *  in HP Service Test.
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            _flow.HTTPActivity5.TextBody = @"{" + Environment.NewLine + @"  ""name"": ""nama saya rudi""," + Environment.NewLine + @"  ""gender"": ""male""," + Environment.NewLine + @"  ""email"": ""rudi.itsmyname1@ymail.com""," + Environment.NewLine + @"  ""status"": ""active""" + Environment.NewLine + @"}";
            _flow.HTTPActivity5.TextXmlBody = @"";
            _flow.HTTPActivity5.FileBody = @"";
            _flow.HTTPActivity5.PostBody = @"";
            _flow.HTTPActivity5.Url = @"https://gorest.co.in/public/v1/users";
            _flow.HTTPActivity5.HttpMethod = @"POST";
            _flow.HTTPActivity5.HttpVersion = @"1.1";
            _flow.HTTPActivity5.RequestHeaders = new Pair<string, string>[2];
            _flow.HTTPActivity5.RequestHeaders[0] = new Pair<string, string>();
            _flow.HTTPActivity5.RequestHeaders[0].Key = @"Authorization";
            _flow.HTTPActivity5.RequestHeaders[0].Value = @"6d2638cbfc0cbd6349e11354a41319e8f233878017134150bbc85769b6daabb3";
            _flow.HTTPActivity5.RequestHeaders[1] = new Pair<string, string>();
            _flow.HTTPActivity5.RequestHeaders[1].Key = @"Content-Type";
            _flow.HTTPActivity5.RequestHeaders[1].Value = @"application/json";
            ...
            _flow.HTTPActivity5.Name = @"HTTP RequestPOST";
...
@"<Object jsonType=""Object"" isAnonymous=""true""><name jsonType=""String"">nama saya judi</name><gender jsonType=""String"">male</gender><email jsonType=""String"">judi.itsmyname1@ymail.com</email><status jsonType=""String"">active</status></Object>");
...
@"<Arguments><ResponseHttpVersion /><StatusCode /><StatusDescription /><ResponseBody /><ResponseBodyAsBase64 /></Arguments>");
            ...
            _flow.HTTPActivity4.Url = @"https://gorest.co.in/public/v1/users";
            ...
            _flow.HTTPActivity4.RequestHeaders[0].Key = @"Authorization";
            _flow.HTTPActivity4.RequestHeaders[0].Value = @"6d2638cbfc0cbd6349e11354a41319e8f233878017134150bbc85769b6daabb3";
            _flow.HTTPActivity4.RequestHeaders[1] = new Pair<string, string>();
            _flow.HTTPActivity4.RequestHeaders[1].Key = @"Content-Type";
            _flow.HTTPActivity4.RequestHeaders[1].Value = @"application/json";
            ...
            _flow.HTTPActivity4.Name = @"HTTP RequestGET";
...
@"<Object jsonType=""Object"" isAnonymous=""true""><name jsonType=""String"">nama saya rudi</name><gender jsonType=""String"">male</gender><email jsonType=""String"">rudi.itsmyname1@ymail.com</email><status jsonType=""String"">active</status></Object>");
